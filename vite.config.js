        ...
        build: {
            ...
            rollupOptions: {
                input: {
                    ...
                    dogfood: resolve(__dirname, 'examples/dogfood/index.html'),
                    weaponSkins: resolve(__dirname, 'examples/dogfood/weapon-skins/index.html'),
                    scrollSite: resolve(__dirname, 'examples/dogfood/scroll-site/index.html'),
                    samsungTv: resolve(__dirname, 'examples/dogfood/samsung-tv/index.html'),
                },
            },
        },
