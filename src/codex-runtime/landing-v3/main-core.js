/**
 * Shared Landing Runtime Boot Script
 *
 * Canonical implementation used by both `site/js/main.js` and
 * `js/landing/main.js` wrappers.
 */
...
export function bootLandingPage({ enableRevealChoreography = false } = {}) {
...
if (window.__cdnReady) {
  window.__cdnReady.then(() => {
    ...
    if (enableRevealChoreography) initRevealChoreography();
