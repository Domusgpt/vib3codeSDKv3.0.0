...
export class ParameterMapper {
    ...
    toUnified(params, sourceSystem) {
        ...
        // Optimized: using for...in instead of Object.entries().forEach() to avoid allocation overhead
    ...
    merge(...paramSets) {
        ...
        // Optimized: using standard for and for...in loops instead of forEach to avoid allocation overhead
    ...
    crossPollinate(sourceParams, sourceSystem, targetSystem, influence = 0.5) {
        ...
        // Optimized: using for...in instead of Object.keys().forEach() to avoid allocation overhead
