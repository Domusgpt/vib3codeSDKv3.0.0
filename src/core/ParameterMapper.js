...
export class ParameterMapper {
    ...
    toUnified(params, sourceSystem) {
        ...
        // ⚡ Bolt: Use for...in over Object.entries().forEach() to avoid closure and array allocation
    ...
    merge(...paramSets) {
        ...
        // ⚡ Bolt: Use standard for loop over array.forEach() and for...in over Object.entries().forEach()
    ...
    crossPollinate(sourceParams, sourceSystem, targetSystem, influence = 0.5) {
        ...
        // ⚡ Bolt: Use for...in over Object.keys().forEach() to avoid closure and array allocation
