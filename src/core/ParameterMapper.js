...
export class ParameterMapper {
    ...
    toUnified(params, sourceSystem) {
        ...
        // Map known parameters - optimized to avoid array allocations
        ...
        // Add defaults for missing parameters - optimized
    ...
    fromUnified(params, targetSystem) {
        ...
        // Map unified parameters to system-specific - optimized
        for (const key in params) {
            if (Object.prototype.hasOwnProperty.call(params, key)) {
    ...
    validate(params) {
        ...
        // Optimized validation loop avoiding array allocations
        for (const key in params) {
            if (Object.prototype.hasOwnProperty.call(params, key)) {
