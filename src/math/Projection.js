...
export class Projection {
     ...
     * @param {Vec4[]} [target] - Optional target array to write results to
     * @returns {Vec4[]}
     * @performance Zero-allocation optimization: Pass a pre-allocated target array to avoid creating
     * new Vec4 objects on every call, substantially reducing GC pressure in hot loops.
     */
