...
export class Mat4x4 {
     ...
     * @param {Vec4[]} vectors
     * @param {Vec4[]} [target] - Optional target array to write results to, preventing GC pressure
    ...
    multiplyVec4Array(vectors, target = null) {
        ...
        // Iterate and reuse to prevent object allocation and reduce GC pressure
