...
export class QuantumEngine {
    ...
    updateParameter(param, value) {
        ...
        // Optimization: Standard for loop avoids closure allocation in this hot path
    ...
    _renderDirectFrame() {
        ...
        // Optimization: Standard for loop avoids closure allocation in this hot render loop
        for (let i = 0, len = this.visualizers.length; i < len; i++) {
            const visualizer = this.visualizers[i];
