...
export class RealHolographicSystem {
        ...
        const render = () => {
            ...
            if (this.isActive) {
                ...
                if (this._renderMode === 'bridge') {
                    ...
                    // @performance Replaced .forEach with standard for loop to avoid closure allocation and reduce GC pressure
    ...
    render(frameState = {}) {
        ...
        if (frameState.params) {
            // @performance Replaced Object.keys().forEach with for...in loop to avoid closure and array allocations
        ...
        if (this._renderMode === 'bridge') {
            ...
            // @performance Replaced .forEach with standard for loop to avoid closure allocation
            for (let i = 0, len = this.visualizers.length; i < len; i++) {
