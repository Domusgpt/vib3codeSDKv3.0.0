...
export class RealHolographicSystem {
    ...
    render(frameState = {}) {
        ...
        if (frameState.params) {
            // ⚡ Bolt: Using for...in instead of Object.keys().forEach to eliminate
            // intermediate array allocation and closure overhead in the render path.
        ...
        if (this._renderMode === 'bridge') {
            ...
            // ⚡ Bolt: Using standard for loop instead of .forEach to prevent
            // closure allocations in the high-frequency render loop, reducing GC pressure.
