...
export class RealHolographicSystem {
    ...
    updateParameter(param, value) {
        ...
        for (let index = 0, _len = this.visualizers.length; index < _len; index++) {
    ...
    updateVariant(newVariant) {
        ...
        for (let _i = 0, _len = this.visualizers.length; _i < _len; _i++) {
            const visualizer = this.visualizers[_i];
