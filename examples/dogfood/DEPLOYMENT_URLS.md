...
## 🕹️ Individual Artifacts

### 1. Weapon Skin Forge (Agent A)
**[Launch App](https://domusgpt.github.io/vib34d-xr-quaternion-sdk/examples/dogfood/weapon-skins/index.html)**
*WebGL skin modding tool with SDF masking and comparison mode.*

### 2. The Fourth Dimension (Agent B)
**[Launch Site](https://domusgpt.github.io/vib34d-xr-quaternion-sdk/examples/dogfood/scroll-site/index.html)**
*Scroll-driven creative web experience explaining 4D geometry.*

### 3. Samsung TV Visualizer (Agent D)
**[Launch App](https://domusgpt.github.io/vib34d-xr-quaternion-sdk/examples/dogfood/samsung-tv/index.html)**
*10-foot UI visualizer. Use Arrow Keys/Enter to simulate remote control.*
