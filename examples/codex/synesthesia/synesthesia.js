...
app.init().then((ok) => {
  if (!ok) {
    ...
    const mode = app.learningMode?.toUpperCase?.() || 'L4';
    document.body.innerHTML = `
      <main style="min-height:100vh;padding:32px;background:#06070a;color:#fff;font-family:Inter,system-ui,sans-serif;line-height:1.6">
        <h2 style="font-weight:600;letter-spacing:.03em;margin-bottom:8px">VIB3+ Synesthesia</h2>
        <p style="opacity:.8;margin-bottom:14px">Renderer initialization failed in this environment. This usually means WebGL/GPU is unavailable.</p>
        <p style="opacity:.7;margin-bottom:18px">Requested learning mode: <strong>${mode}</strong></p>
        <div style="display:flex;gap:8px;flex-wrap:wrap">
          <a href="./README.md" style="color:#fff;text-decoration:none;border:1px solid rgba(255,255,255,.25);padding:8px 10px;border-radius:8px">Open Synesthesia README</a>
          <a href="./mcp-labs/" style="color:#fff;text-decoration:none;border:1px solid rgba(255,255,255,.25);padding:8px 10px;border-radius:8px">Open MCP Labs</a>
          <a href="../index.html" style="color:#fff;text-decoration:none;border:1px solid rgba(255,255,255,.25);padding:8px 10px;border-radius:8px">Back to Codex</a>
        </div>
      </main>
    `;
  }
