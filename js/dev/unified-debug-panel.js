...
function createPanel() {
  ...
  panel.innerHTML = `
    ...
    <div class="metrics">
      ...
      <div class="metric"><span>Projected</span><span class="value" data-value="projected">false</span></div>
      <div class="metric"><span>Geometry</span><span class="value" data-value="geometry">cube</span></div>
      <div class="metric"><span>Stroke</span><span class="value" data-value="stroke">1.0</span></div>
    </div>
...
function wirePanel(panel) {
  ...
  const projectedEl = panel.querySelector('[data-value="projected"]');
  const geometryEl = panel.querySelector('[data-value="geometry"]');
  const strokeEl = panel.querySelector('[data-value="stroke"]');
  ...
  const updateMetrics = () => {
    ...
    projectedEl.textContent = cues?.projected ? 'true' : 'false';
    geometryEl.textContent = cues?.geometry ?? 'cube';
    strokeEl.textContent = cues?.strokeWidth?.toFixed?.(2) ?? '1.0';
