...
- [ ] Add rotor/matrix utilities for the six rotation planes.
- [ ] Implement stereographic + perspective projection helpers.
- [ ] Add rotation drift/stability tests.

### Phase 2 — Rendering core consolidation
- [ ] Define renderer contracts and resource manager interfaces.
...
- [ ] Define MCP tools for create/apply/render workflows.
- [ ] Emit structured telemetry spans and error schemas.
- [ ] Implement CLI JSON output and non-interactive modes.
