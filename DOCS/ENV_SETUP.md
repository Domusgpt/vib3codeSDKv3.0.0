...
This guide includes only the SDK/tooling prerequisites; once you decide on a test strategy, we can extend this with emulator setup or Firebase Test Lab configuration.
