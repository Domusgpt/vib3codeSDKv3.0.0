...
## 2024-05-26 - [Zero-Allocation Geometric Arrays]
...
**Action:** Extend `target` parameter support to core array projection and matrix operations (`Projection.stereographicArray`, `Projection.orthographicArray`, `Mat4x4.multiplyVec4Array`) to support zero-allocation iteration, similar to single-vector target methods.
