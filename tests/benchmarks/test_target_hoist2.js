...
function warpToCellsFastFastFast(vertices, size = 1, cellInfluence = 0.7, target = null) {
...
for (let i = 0; i < ITERATIONS; i++) {
    warpToCellsFastFastFast(vertices, 1, 0.7, target);
}
let end = performance.now();
console.log(`warpToCellsFastFastFast: ${(end - start).toFixed(2)}ms`);
